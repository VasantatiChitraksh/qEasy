...
class DocLocation extends StatefulWidget {
  @override
  DocLocationScreenState createState() => DocLocationScreenState();
}

class DocLocationScreenState extends State<DocLocation> {
